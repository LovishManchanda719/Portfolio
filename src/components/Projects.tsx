...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      image: 'https://drive.google.com/uc?id=10vEmXbHWgekB1486u6jvGyA932-fOQKd'
    },
    {
      name: 'WhatsApp AI Chatbot',
      description: 'Chatbot integrated with Gemini API.',
      image: 'https://drive.google.com/uc?id=1HoEpT1dNUMIzgHe5sdjBL92D0cxOjSt7'
    },
    {
    ...
    <section id="projects" className="py-12">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        {projects.map((project) => (
          <Card key={project.name} className="dark:bg-gray-800 flex flex-col">
            <CardHeader>
            ...
            <CardContent className="flex-1 flex flex-col">
              ...
              {project.link && (
                <a 
                  ...
                  className="text-blue-500 dark:text-blue-400 hover:underline mt-auto"
                >
                  View Project
                </a>
              )}
